      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 text-sm">A taste of our culinary offerings</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {menuItems.map((category, categoryIndex) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h4 className="text-lg font-semibold text-maroon-600 mb-3 border-b border-maroon-200 pb-2">
                  {category.category}
                </h4>
                  ...
                  {category.items.map((item, itemIndex) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-1">
                        <h5 className="font-medium text-slate-800 group-hover:text-maroon-600 transition-colors text-sm">
                          {item.name}
                        </h5>
                        <span className="font-bold text-yellow-600 text-sm">{item.price}</span>
                      </div>
          ...
          >
            <motion.button
              className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white px-6 py-3 rounded-lg font-medium hover:from-yellow-600 hover:to-yellow-700 transition-all"
